            ...
            children: [
              ...
              Expanded(
                child: _QuickActionCard(
                  ...
                  description: 'بلغ جهات الاتصال بتاعتك عن حالتك أوتوماتيكي',
                  icon: Icons.group_rounded,
                  buttonLabel: 'بلغ جهات الاتصال',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(description,
              style:
                  const TextStyle(fontSize: 12, color: Color(0xFF64748B), height: 1.5)),
          const SizedBox(height: 14),
          GestureDetector(
            onTap: () {},
            child: Container(
