"""
Django settings for El7a2ny_backend project.
...
SECRET_KEY = "django-insecure-#ahe$#5=8qov1ev^%$m=xb3oz94zd6v*m&uz6fzt-apwqf7nem"
...
WSGI_APPLICATION = "El7a2ny_backend.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "HOST": "localhost",
        "PORT": "5432",
        "OPTIONS": {"options": "-c search_path=ems_schema,public"},  # السطر ده هو السر
    }
}
